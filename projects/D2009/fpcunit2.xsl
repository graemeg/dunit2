...
<xsl:template match="/">
  ...
  <p align="right">
    <a href="http://validator.w3.org/check?uri=referer"><img src="http://www.w3.org/Icons/valid-html40" border="0" alt="Valid HTML 4.0 Transitional" height="31" width="88"/></a>
  </p>
</body>
</html>
</xsl:template>
...
**********************************************************************  
-->
  <xsl:template name="test_project" match="TestProject">
        ...
        <tr>
          ...
          <td>
            ...
            <div>
              ...
              <xsl:apply-templates name="test_project">
  ...
  <xsl:template name="test_decorator" match="TestDecorator">
    <xsl:param name="depth"/>
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <!-- If first level of depth, do not shift of $param-shift-width-->
          ...
          <td>
            ...
            <div>
              ...
              <!-- Thanks to the magic of recursive calls, all the descendants of 
                   the current folder are going to be built -->
              <xsl:apply-templates name="test_decorator">
                <xsl:with-param name="depth" select="$depth+1"/>
              </xsl:apply-templates>
              <!-- print all the leaves of this folder-->
              <xsl:apply-templates select="/Test"/>
  ...
  <xsl:template name="test_case" match="TestCase">
    <xsl:param name="depth"/>
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <!-- If first level of depth, do not shift of $param-shift-width-->
          ...
          <td>
            ...
            <div>
              ...
              <!-- Thanks to the magic of recursive calls, all the descendants of 
                   the current folder are going to be built -->
              <xsl:apply-templates name="test_case">
                <xsl:with-param name="depth" select="$depth+1"/>
              </xsl:apply-templates>
              <!-- print all the leaves of this folder-->
              <xsl:apply-templates select="/Test"/>
...
-->
          ...
          <xsl:choose>
            <xsl:when test="@Result = 'Error'">
              <xsl:call-template name="error_results"/>
            </xsl:when>
            <xsl:when test="@Result = 'Failed'">
              <xsl:call-template name="failed_results"/>
            </xsl:when>
          </xsl:choose>
